...
def string_search(input_string):
    ...
    "Suffix": sorted(set(matched_suffix_list), key=len, reverse=True)[0] if matched_suffix_list else None
        ...
        if (output_dict["Root"] if output_dict["Root"] else '') + output_dict["Suffix"] == input_string:
            final_output_1 =  {
